...
public:
    CMainParams() {
        ...
        genesis.nNonce   = 8119707;

        hashGenesisBlock = genesis.GetHash();


          assert(hashGenesisBlock == uint256("0x000009f28c827b0887a28e52427e958949577071cac33e1597a1238a27ffdbb8"));
          assert(genesis.hashMerkleRoot == uint256("0x7af4a2b5867c5545d1452dfe116325681d19949708e8d9836489f576dab8cfab"));

        //MineGenesis(genesis);

        vSeeds.push_back(CDNSSeedData("seed1.ketosiscoin.com", "seed1.ketosiscoin.com")); // XSPC Network Node 1
        vSeeds.push_back(CDNSSeedData("seed2.ketosiscoin.com", "seed2.ketosiscoin.com")); // XSPC Network Node 2
        vSeeds.push_back(CDNSSeedData("seed3.ketosiscoin.com", "seed3.ketosiscoin.com")); // XSPC Network Node 3
...
public:
    CTestNetParams() {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 107); // ketosis test net start with k
