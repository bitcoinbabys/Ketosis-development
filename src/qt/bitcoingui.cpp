...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolButton { background-color:rgb(255, 255, 255);color:rgb(255, 171, 0); font-weight:bold; padding:2px 0px 2px 5px; border:none;} QToolButton:hover {background-color:rgb(255, 171, 0);color:rgb(255, 255,255);} QToolButton:checked { background-color:rgb(255, 255, 255);color:rgb(0, 182, 0); } QToolButton:pressed { background-color:rgb(255, 171, 0);color:rgb(255, 255, 255); } #tabs { }");


    if (fUseBlackTheme)
    {
        QWidget* header = new QWidget();
        header->setMinimumSize(160, 200); // Changed this for new header
        header->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
        header->setStyleSheet("QWidget { background-color: rgb(255,255,255); background-repeat: no-repeat; background-image: url(:/images/header); background-position: center center; border:none;}");
...
void BitcoinGUI::setNumBlocks(int count)
{
    ...
    else
    {
        ...
        progressBarLabel->setText(tr(clientModel->isImporting() ? "Importing blocks..." : "Synchronizing with KETO network..."));
