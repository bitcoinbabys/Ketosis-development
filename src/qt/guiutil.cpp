...
void SetBlackThemeQSS(QApplication& app) // KETO Colors : Orange :  rgb(255, 171, 0) - Green : rgb(0, 182, 0)
{
    app.setStyleSheet("QWidget        { color:rgb(30, 32, 36); background: rgb(255,255,255); }" // changed // Dashboard Pages Background ** Needs to stay white
                      "QFrame         { border: none; }"
                      "QComboBox      { color: rgb(0, 182, 0); }" // Drop List to Green
                      "QComboBox QAbstractItemView::item { color: rgb(0, 182, 0); }" // Drop List to Green
                      ...
                      "QLineEdit      { background: rgb(63,67,72); color: rgb(255, 171, 0); border-color: rgb(194,194,194); }" // Input Text Orange
                      "QTextEdit      { background: rgb(63,67,72); color: rgb(255, 171, 0); }"
                      "QPlainTextEdit { background: rgb(63,67,72); color: rgb(255, 171, 0); }"
                      "QMenuBar       { background: color: rgb(255, 171, 0); color: rgb(110,116,126); }" //changed Top Menu
