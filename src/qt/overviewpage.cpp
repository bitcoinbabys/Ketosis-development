...
public:
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(fUseBlackTheme ? QColor(0, 182, 0) : foreground);
        ...
        painter->setPen(fUseBlackTheme ? QColor(0, 182, 0) : option.palette.color(QPalette::Text));
    ...
    filter(0)
{
    ...
    if (fUseBlackTheme)
    {
        const char* whiteLabelQSS = "QLabel { color: rgb(0, 182, 0); }";
